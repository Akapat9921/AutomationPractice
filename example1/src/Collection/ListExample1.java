...
public class ListExample1 {
	...
	public static void main(String[] args) {
		...
		l2.add("Pune");//object obj = "Pune"; --->upcating
		l2.add(12);//object obj = --->boxing --->upcasting
		l2.add(null);
		l2.add("Pune");
		System.out.println("list elements are: "+l2);
		l2.add(2,"Mango");
		System.out.println("List elements are: "+l2);
		System.out.println("List elements count: "+l2.size());
		//System.out.println("List element at index 4: "+l2.get(4));
		
		l2.set(4,"Mumbai");
		System.out.println("Updated elements are: "+l2);
		System.out.println("Updated list elements count: "+l2.size());
		
		for(int i=0; i<l2.size(); i++) {
			System.out.println("list elements at index "+i+" :"+l2.get(i) );
		}
		
		System.out.println("*******************For using each loop**********************");
		for(Object obj:l2) {
